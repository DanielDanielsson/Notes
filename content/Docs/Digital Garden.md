...
Forget the elaborate systems. The only things that matter:

**Link your notes.** When you write something and it reminds you of something else, link them. This is the whole point. Over time, you build a web of connected ideas that's genuinely useful for thinking.

**Write for yourself.** If you're performing for an audience, you'll either burn out or stop writing anything honest. Your garden should help *you* think. If others find it useful, that's a bonus.

**Don't over-organize.** Every hour spent building the perfect folder structure is an hour not spent actually thinking. Tags and links are enough. Structure emerges from use.

**Revisit old notes.** A garden needs tending. When you return to a note months later, you'll often see it differently. Update it. Merge it with other notes. Delete it if it's useless. This is how ideas mature.

The real test is simple: does your garden help you think better? If yes, keep going. If not, change something.
